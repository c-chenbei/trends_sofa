...
Alothemes.SwitchRTL = function () {
    $('.switch-rtl-ltr').click(function() {
        ...
        if(!$('#rtl-style').length){
            $('head').append('<link rel="stylesheet" id="rtl-style" href="//trendssofa.com/cdn/shop/t/19/assets/style.rtl.css?v=39336918034591178091696822742" type="text/css" />');
        }
    });
}();
    ...
    ProductGallery.prototype = $.extend({}, ProductGallery.prototype, {
        ...
        zoomConfig: function () {
            var zoomImage = $(this.selectors.main),
                ...
                zoomLevel  = (zoomStyle == 2 || zoomStyle == 4) ? 1 : zoomImage.data("zoomLevel") ? zoomImage.data("zoomLevel") : '0.7',
